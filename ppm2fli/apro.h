...
#define FLI_MAX_X  4000
#define FLI_MAX_Y  4000
#define FLI_MAX_COLORS 256
#define FLI_MAX_FRAMES 20000
...
EXT char *palfname; /* storage for pallete file name */
EXT int numr8comments; /* number of comments at header of raw r8 file */
EXT UBYTE pal[3][256];
EXT FILE * pal_file;
/* prototypes */
